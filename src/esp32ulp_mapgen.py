#!/usr/bin/env python
# esp32ulp_mapgen utility converts a symbol list provided by nm
# into an export script for the linker and a header file.
#
# Copyright (c) 2016-2017 Espressif Systems (Shanghai) PTE LTD.
# Distributed under the terms of Apache License v2.0
# found in the top-level LICENSE file.
...
def main():
    description = (
        "This application generates .h and .ld files for symbols defined"
        " in input file. "
